...
const skipTests = Deno.env.get("CI") === "true" ||
...
Deno.test("should create MCP manager for single server", {
  sanitizeOps: false,
...
Deno.test("should reuse existing manager for same config", {
  sanitizeOps: false,
  sanitizeResources: false,
  ignore: skipTests,
}, async () => {
...
Deno.test("should create separate managers for different configs", {
  sanitizeOps: false,
  sanitizeResources: false,
  ignore: skipTests,
}, async () => {
...
Deno.test("should handle multiple servers in single config", {
  sanitizeOps: false,
  sanitizeResources: false,
  ignore: skipTests,
}, async () => {
...
Deno.test("should generate different keys for different server combinations", {
  sanitizeOps: false,
  sanitizeResources: false,
  ignore: skipTests,
}, async () => {
...
Deno.test("should track reference counts correctly", {
  sanitizeOps: false,
  sanitizeResources: false,
  ignore: skipTests,
}, async () => {
...
Deno.test("should handle empty server configs", {
  sanitizeOps: false,
  sanitizeResources: false,
  ignore: skipTests,
}, async () => {
...
Deno.test("should handle server registration failures gracefully", {
  sanitizeOps: false,
  sanitizeResources: false,
  ignore: skipTests,
}, async () => {
...
Deno.test("should clean up pool on disposal", {
  sanitizeOps: false,
  sanitizeResources: false,
  ignore: skipTests,
}, async () => {
...
Deno.test("should generate consistent keys for same configs", {
  sanitizeOps: false,
  sanitizeResources: false,
  ignore: skipTests,
}, async () => {
...
Deno.test("should generate different keys for different server IDs", {
  sanitizeOps: false,
  sanitizeResources: false,
  ignore: skipTests,
}, async () => {
...
Deno.test("should handle server ID ordering consistently", {
  sanitizeOps: false,
  sanitizeResources: false,
  ignore: skipTests,
}, async () => {
  ...
  const config1 = {
    "a": createTimeServerConfig(),
    "b": createGitServerConfig(),
  };
  const config2 = {
    "b": createGitServerConfig(),
    "a": createTimeServerConfig(),
