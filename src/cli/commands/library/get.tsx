...
const ItemDetailDisplay: React.FC<ItemDetailDisplayProps> = ({ itemDetail, includeContent }) => {
  ...
  return (
    <Box flexDirection="column">
      ...
      <Box marginBottom={1}>
        <Text>
          <Text bold>Source:</Text> {item.source} | <Text bold>MIME Type:</Text>{" "}
      ...
      {item.template_id && (
        <Box marginBottom={1}>
          <Text>
            <Text bold>Template:</Text> {item.template_id}
          </Text>
        </Box>
      )}
      ...
      {item.generated_by && (
        <Box marginBottom={1}>
          <Text>
            <Text bold>Generated By:</Text> {item.generated_by}
          </Text>
        </Box>
      )}
      ...
      {item.session_id && (
        <Box marginBottom={1}>
          <Text>
            <Text bold>Session:</Text> {item.session_id}
          </Text>
        </Box>
      )}
      ...
      {item.agent_ids && item.agent_ids.length > 0 && (
        <Box marginBottom={1}>
          <Text>
            <Text bold>Agents:</Text> {item.agent_ids.join(", ")}
          </Text>
        </Box>
      )}
