...
export function useKeypress(
  ...
  useEffect(() => {
    ...
    const keypressStream = new stream.PassThrough();
    ...
    const handleRawKeypress = (data: Buffer) => {
      const PASTE_MODE_PREFIX = Buffer.from(START_BUFFER_CHARACTER);
      const PASTE_MODE_SUFFIX = Buffer.from(END_BUFFER_CHARACTER);
