...
Deno.test({
  ...
  async fn(t) {
    ...
    const result = await googleCalendarAgent.execute(
      "Please provide availability looking at both my personal and work calendar for this upcoming week. I am looking for a good time to meet with someone in Los Angeles for 1 hr.",
      context,
    );
