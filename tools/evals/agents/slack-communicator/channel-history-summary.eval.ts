  ...
  async fn(t) {
    ...
    const evaluation = await llmJudge({
      criteria: `
        ...
        3. Include key topics, decisions, or action items if present
        4. Be formatted appropriately for Slack consumption
        5. Not include excessive technical details about the execution process
      `,
      agentOutput: result,
    });
