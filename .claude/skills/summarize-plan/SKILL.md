...
name: summarize-plan
description: >
  Consolidate completed planning documents into a concise source-of-record
  reference. Use after a feature is implemented and there are one or more plan
  docs (design docs, iteration versions, review reports) that should be distilled
  into a single post-implementation reference for future developers and AI
  agents. Triggers: "close out the plan", "consolidate the plan docs",
  "create a source of record", "combine these plans", "archive these design
  docs".
---
