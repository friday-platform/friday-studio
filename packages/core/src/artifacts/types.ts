...
/**
 * Adapter interface for artifact storage. Single implementation today
 * (LocalStorageAdapter, Deno KV–backed); the interface is preserved so
 * the planned Object-Store-backed redesign can swap in cleanly.
