...
describe("Workspace Building Tools", () => {
  ...
  describe("initializeWorkspace", () => {
    it("should initialize workspace with valid parameters", async () => {
      resetBuilder();
  ...
  describe("addScheduleSignal", () => {
    it("should add valid schedule signal", async () => {
      resetBuilder();
      await workspaceBuilderTools.initializeWorkspace.execute!({
        name: "test-workspace",
    ...
    it("should prevent duplicate signal names", async () => {
      resetBuilder();
      await workspaceBuilderTools.initializeWorkspace.execute!({
        name: "test-workspace",
        description: "Test workspace",
  ...
  describe("addWebhookSignal", () => {
    it("should add valid webhook signal", async () => {
      resetBuilder();
      await workspaceBuilderTools.initializeWorkspace.execute!({
        name: "test-workspace",
        description: "Test workspace",
  ...
  describe("addLLMAgent", () => {
    it("should add valid LLM agent", async () => {
      resetBuilder();
      await workspaceBuilderTools.initializeWorkspace.execute!({
        name: "test-workspace",
        description: "Test workspace",
  ...
  describe("addRemoteAgent", () => {
    it("should add valid remote agent", async () => {
      resetBuilder();
      await workspaceBuilderTools.initializeWorkspace.execute!({
        name: "test-workspace",
        description: "Test workspace",
  ...
  describe("createJob", () => {
    it("should create valid job with signal and agent references", async () => {
      resetBuilder();
      await workspaceBuilderTools.initializeWorkspace.execute!({
        name: "test-workspace",
        description: "Test workspace",
    ...
    it("should fail with invalid signal reference", async () => {
      resetBuilder();
      await workspaceBuilderTools.initializeWorkspace.execute!({
        name: "test-workspace",
        description: "Test workspace",
    ...
    it("should fail with invalid agent reference", async () => {
      resetBuilder();
      await workspaceBuilderTools.initializeWorkspace.execute!({
        name: "test-workspace",
        description: "Test workspace",
  ...
  describe("addMCPIntegration", () => {
    it("should add valid MCP server integration", async () => {
      resetBuilder();
      await workspaceBuilderTools.initializeWorkspace.execute!({
        name: "test-workspace",
        description: "Test workspace",
    ...
    it("should work with default args and without env", async () => {
      resetBuilder();
      await workspaceBuilderTools.initializeWorkspace.execute!({
        name: "test-workspace",
        description: "Test workspace",
  ...
  describe("validateWorkspace", () => {
    it("should validate complete workspace configuration", async () => {
      resetBuilder();
      await workspaceBuilderTools.initializeWorkspace.execute!({
    ...
    it("should fail validation for incomplete workspace", async () => {
      resetBuilder();
  ...
  describe("exportWorkspace", () => {
    it("should export complete workspace configuration", async () => {
      resetBuilder();
      await workspaceBuilderTools.initializeWorkspace.execute!({
    ...
    it("should include MCP tools section when servers exist", async () => {
      resetBuilder();
      await workspaceBuilderTools.initializeWorkspace.execute!({
        name: "mcp-workspace",
    ...
    it("should fail export without workspace identity", async () => {
      resetBuilder();
      // Don't initialize workspace
  ...
  describe("Tool integration", () => {
    it("should support complete workspace building workflow", async () => {
      resetBuilder();
