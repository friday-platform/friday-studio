...
Bundled agents are common integrations like Slack, GitHub, and Jira that come ready-to-use with
Atlas. They're compiled into the Atlas binary and available immediately without any setup.
...
Both types are loaded through the `BundledAgentAdapter` and made available through Atlas's unified
MCP server.
...
Each agent handles natural language requests within their domain and provides specialized tools and
knowledge.
