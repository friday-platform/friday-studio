...
describe("pruneMessages", () => {
  ...
  it("reasoning - before-trailing-message", () => {
  ...
  it("toolCalls - before-last-message", () => {
  ...
  it("toolCalls - before-last-2-messages", () => {
  ...
  it("bug reproduction: completed tool call before last message should be pruned", () => {
