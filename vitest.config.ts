...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      $lib: fileURLToPath(new URL("./apps/studio-ui/src/lib", import.meta.url)),
      "$app/environment": fileURLToPath(
        new URL("./apps/studio-ui/src/lib/__test-stubs__/app-environment.ts", import.meta.url),
      ),
    },
  },
  test: {
    ...
    exclude: [
      ...
      "apps/studio-ui/src/lib/components/mcp/mcp-credentials-panel.test.ts",
    ],
