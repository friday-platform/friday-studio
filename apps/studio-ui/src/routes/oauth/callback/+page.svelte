<script lang="ts">
  ...
  /**
   * OAuth callback page for popup-based credential linking.
   * Receives credential_id and provider from URL params, posts message
   * to opener window, and closes the popup.
   */
...
<div class="callback-container">
  ...
  {:else if status === "no-opener"}
    <div class="status-box success">
      <p>Authentication successful!</p>
      <p class="hint">You can close this window and return to the playground.</p>
    </div>
