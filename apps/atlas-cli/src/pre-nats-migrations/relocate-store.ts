 ...
 * paths. Used by support to confirm where the migration was looking
 * even on noop / dry-run paths.
 */
...
export async function runRelocate(
  ...
  // success), exactly once per call, before any filesystem probe. Gives
