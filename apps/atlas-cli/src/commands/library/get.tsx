...
const ItemDetailDisplay: React.FC<ItemDetailDisplayProps> = ({ itemDetail, includeContent }) => {
  ...
  return (
    <Box flexDirection="column">
      ...
      <Box marginBottom={1}>
        <Text>
          <Text bold>Source:</Text> {item.metadata.source} | <Text bold>MIME Type:</Text>{" "}
      ...
      {item.metadata.generated_by && (
        <Box marginBottom={1}>
          <Text>
            <Text bold>Generated By:</Text> {item.metadata.generated_by}
          </Text>
        </Box>
      )}
      ...
      {item.metadata.session_id && (
        <Box marginBottom={1}>
          <Text>
            <Text bold>Session:</Text> {item.metadata.session_id}
          </Text>
        </Box>
      )}

      {item.metadata.agent_ids && item.metadata.agent_ids.length > 0 && (
        <Box marginBottom={1}>
          <Text>
            <Text bold>Agents:</Text> {item.metadata.agent_ids.join(", ")}
          </Text>
        </Box>
      )}
