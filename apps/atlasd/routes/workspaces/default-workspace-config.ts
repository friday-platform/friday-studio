 ...
 *
 * - notes: short-term store for agent writes (observations, results, preferences)
 * - memory: long-term store populated by the global reflector in the system workspace
 *
 * Mounts pull the user workspace's narrative stores into every new workspace
