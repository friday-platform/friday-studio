...
import Anthropic from "$lib/icons/integrations/anthropic.svelte";
import Atlassian from "$lib/icons/integrations/atlassian.svelte";
import Github from "$lib/icons/integrations/github.svelte";
import Gmail from "$lib/icons/integrations/gmail.svelte";
import GoogleCalendar from "$lib/icons/integrations/google-calendar.svelte";
import GoogleDocs from "$lib/icons/integrations/google-docs.svelte";
import GoogleDrive from "$lib/icons/integrations/google-drive.svelte";
import GoogleSheets from "$lib/icons/integrations/google-sheets.svelte";
import Linear from "$lib/icons/integrations/linear.svelte";
import Notion from "$lib/icons/integrations/notion.svelte";
import Posthog from "$lib/icons/integrations/posthog.svelte";
import Sentry from "$lib/icons/integrations/sentry.svelte";
import SlackColor from "$lib/icons/integrations/slack-color.svelte";
