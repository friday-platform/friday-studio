<!-- v6 - 2026-04-27 - Generated via /improving-plans from 2026-04-27-installer-launcher-ux-fixes.v5.md -->

# Installer + Launcher UX Fixes (v6)

**Date:** 2026-04-27
**Branch:** declaw (per Atlas rule)
**Status:** Plan — implementation-ready (converged after 5 review passes)
**Supersedes:** v5 (`2026-04-27-installer-launcher-ux-fixes.v5.md`)

> **Convergence note:** v6 is a small touch-up over v5 — two
> implementation gotchas baked in that aren't design choices but
> would trip up an implementer. Further /improving-plans cycles
> past this are diminishing returns; the next step is to write
> the code.
