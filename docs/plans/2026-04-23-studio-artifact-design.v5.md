<!-- v5 - 2026-04-24 - Generated via /improving-plans from docs/plans/2026-04-23-studio-artifact-design.v4.md -->
...
apps/studio-artifact/
  ...
  service/
    ...
    handler.go         — ServeObject http.HandlerFunc (slash-strip, precondition eval, range parse+clamp, HEAD short-circuit, Cache-Control, streaming)
  Dockerfile
```
