...
1. **📚 TUI Library Tab** - Browse items and templates
2. **💻 CLI Commands** - Full library command suite
3. **🌐 API Endpoints** - REST API for library operations
4. **🔧 Template Engine** - LLM-native prompt processing
5. **💾 Storage System** - Local filesystem backend
